...
public class GattConnectionComparisonTests {
    ...
    private BluetoothDevice getMockDeviceFor() {
        ...
        when(mockDevice.getAddress()).thenReturn(GattConnectionComparisonTests.MOCK_ADDRESS);
        when(mockDevice.getName()).thenReturn(GattConnectionComparisonTests.FOO_1);
        return mockDevice;
    }
}
